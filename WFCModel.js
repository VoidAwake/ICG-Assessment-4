...
class WFCModel {
    ...
    const part = new THREE.Mesh(new THREE.BoxGeometry(1,1,1), new THREE.MeshLambertMaterial());
    ...
    loader.load( './Assets/AurynSky/Dungeon Pack/Models/Floor01D.fbx', function ( object ) {
        // scene.add( object );
        // console.log(object);
        line = object;
